...
export class FooterElement extends LiteElement {
  ...
  render() {
    return html`
    <flex-container>
    <!-- <span class="sides">&copy; 2019-2025</span><img alt="BaikosHome" src="./assets/small.png"> -->
    <socialbutton-element
        ...
        <socialbutton-element
            .href=${"https://maps.google.com/?q=Baiko's Home Bosstraat, Erpe-Mere"}
            .path=${[
            { d: "M3.1 11.2a.5.5 0 0 1 .4-.2H6a.5.5 0 0 1 0 1H3.75L1.5 15h13l-2.25-3H10a.5.5 0 0 1 0-1h2.5a.5.5 0 0 1 .4.2l3 4a.5.5 0 0 1-.4.8H.5a.5.5 0 0 1-.4-.8z", fillRule: "evenodd" },
            { d: "M4 4a4 4 0 1 1 4.5 3.969V13.5a.5.5 0 0 1-1 0V7.97A4 4 0 0 1 4 3.999z", fillRule: "evenodd" }
            ]}
        >
            <p>Bosstraat 136<br> 9420 Mere, België</p>
        </socialbutton-element>
    <flex-column>
    <flex-column>
        ...
        <flex-row>
            ...
            ></socialbutton-element>
            <socialbutton-element
                .href=${'https://www.facebook.com/BaikosHome'}
            ...
            ></socialbutton-element>
        </flex-row></flex-column>    </flex-container>
    `;
  }
}
