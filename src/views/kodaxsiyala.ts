...
export class KodaxsiyalaView extends LiteElement {
  ...
  private getChartConfig() {
    ...
    const datasets = [
      ...
      { label: 'Valko', data: [334, 350, 374, 402, 450, 506, 542, 580, 642, 716, 744, 786, 848, 890, 930, 970, 1030, 1080, 1145, 1190, 1235, 1300, 1335, 1365, 1390, 1530, 1615,
        1712, 1810, 1895, 2025, 2145, 2265, 2392, 2520, 2620, 2710, 2805, 2961, 3117, 3275, 3385, 3495, 3605, 3715
      ] },
      { label: 'Aiko', data: [260, 272, 308, 338, 380, 434, 472, 518, 566, 602, 632, 672, 702, 734, 764, 794, 824, 866, 902, 942, 970, 1025, 1045, 1075, 1105, 1215, 1305,
        1391, 1480, 1560, 1680, 1802, 1925, 2077, 2230, 2310, 2420, 2585, 2701, 2817, 2935, 3063, 3192, 3321, 3450
      ] },
      { label: 'Yira', data: [412, 410, 430, 470, 522, 572, 648, 684, 722, 792, 816, 854, 884, 908, 935, 962, 1010, 1035, 1070, 1100, 1130, 1190, 1245, 1270, 1290, 1385, 1500,
        1595, 1690, 1780, 1905, 2005, 2105, 2257, 2410, 2515, 2620, 2770, 2868, 2966, 3065, 3210, 3355, 3500, 3645
      ] },
      { label: 'Izumi', data: [300, 308, 334, 364, 420, 476, 520, 560, 612, 674, 690, 756, 800, 820, 841, 862, 914, 962, 1045, 1100, 1160, 1180, 1210, 1245, 1280, 1355, 1475,
        1547, 1620, 1675, 1740, 1827, 1915, 2024, 2140, 2230, 2320, 2430, 2568, 2706, 2845, 2932, 3020, 3107, 3195
      ] },
      { label: 'Reu 3', data: [398, 418, 448, 490, 556, 622, 676, 720, 768, 834, 858, 908, 932, 968, 998, 1035, 1075, 1105, 1140, 1150, 1165, 1245, 1295, 1345, 1355, 1480, 1600,
        1687, 1775, 1860, 2010, 2125, 2240, 2402, 2565, 2705, 2765, 2950, 3113, 3276, 3440, 3596, 3752, 3908, 4065
      ] },
    ];
    ...
    <flex-container>
      ...
      .images=${[
        ...
        <ul>
            ...
            <li>Yipping Yevee - 17:10 - 330g - Brown Tricolor</li>
      ...
      .images=${[
        ...
        './img/litters/kodaxsiyala/teef1n.webp',
        './img/litters/kodaxsiyala/teef1o.webp'
      ]}
      ...
      <post-element
        .images=${[
          ...
          './img/litters/kodaxsiyala/reu1c.webp',
          './img/litters/kodaxsiyala/reu1d.webp',
          ...
          './img/litters/kodaxsiyala/reu1m.webp',
          './img/litters/kodaxsiyala/reu1n.webp'
        ]}
      ...
      <post-element
        .images=${[
          ...
          './img/litters/kodaxsiyala/teef2o.webp',
          './img/litters/kodaxsiyala/teef2p.webp'
        ]}
        headline="Yipping Yevee"
      ...
      <post-element
        .images=${[
          ...
          './img/litters/kodaxsiyala/reu2m.webp',
          './img/litters/kodaxsiyala/reu2n.webp'
        ]}
      ...
      <post-element
        .images=${[
          ...
          './img/litters/kodaxsiyala/reu3n.webp',
          './img/litters/kodaxsiyala/reu3o.webp'
        ]}
        headline="Reu 3"
        subline="Brown Sable Merle"
      ></post-element>
      <post-element
        .images=${[
          ...
          './img/litters/kodaxsiyala/teef3n.webp',
          './img/litters/kodaxsiyala/teef3o.webp'
        ]}
