...
export class KodaxsiyalaView extends LiteElement {
  ...
  private getChartConfig() {
    ...
    const datasets = [
      { label: 'Teef 1', data: [412, 410, 430, 470, 522, 572, 648, 684, 722, 792, 816, 854, 884, 908, 935, 962, 1010, 1035, 1070] },
      { label: 'Reu 1', data: [334, 350, 374, 402, 450, 506, 542, 580, 642, 716, 744, 786, 848, 890, 930, 970, 1030, 1080, 1145] },
      { label: 'Teef 2', data: [330, 340, 366, 398, 442, 504, 560, 620, 676, 730, 760, 796, 840, 874, 889, 934, 970, 1015, 1075] },
      { label: 'Reu 2', data: [260, 272, 308, 338, 380, 434, 472, 518, 566, 602, 632, 672, 702, 734, 764, 794, 824, 866, 902] },
      { label: 'Reu 3', data: [398, 418, 448, 490, 556, 622, 676, 720, 768, 834, 858, 908, 932, 968, 998, 1035, 1075, 1105, 1140] },
      { label: 'Teef 3', data: [300, 308, 334, 364, 420, 476, 520, 560, 612, 674, 690, 756, 800, 820, 841, 862, 914, 962, 1045] },
    ];
