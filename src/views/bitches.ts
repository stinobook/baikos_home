...
export class BitchesView extends LitElement {
  static styles = [
    css`
      :host {
        display: flex;
      ...
      @media (max-width: 1280px) {
        ...
        .flex-container { padding: 0 16px; gap: 16px; box-sizing: border-box; }
